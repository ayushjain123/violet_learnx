...
if(isset($_POST["name"]) && isset($_POST["phone"]) && isset($_FILES['file']['name'])){
...
$conn=mysqli_connect('localhost','root','','shopdb');
 ...
 if(!$conn) {
   ...
   $sql="UPDATE users SET name='$name',picture='$newname', phone='$phone' WHERE username='".$_SESSION["user"]."'";
  ...
  ?>
    ...
    <div class="inner_cont4">
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <div class="profile_pic" style="float:right; font-size: 10pt; padding-top: 18%; padding-left: 10px; padding-right: 10px">Upload profile Picture <br><br>
                <form enctype="multipart/form-data" action="edit_profile.php" method="post"><input type="file" name="file" ></form>
                    <br>
          </div>
          ...
          <div class="col-sm-8">
            <div class="contents">
              ...
              <table border="0" cellpadding="0" cellspacing="0" align="left" width="70%" height="250px" style="color: rgba(0,0,0,0.6);">
                ...
                <tr>
                    <td colspan="2"><input type="submit" name="" class="btn btn-outline-info" value="save"></td>
                  </tr>
                </table>
              </div>
                </div>
